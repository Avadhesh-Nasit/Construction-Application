...
import 'package:construction_application/admin/report_property_details.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot> (
          stream: FirebaseFirestore.instance.collection('reportProperty').snapshots(),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            FirebaseFirestore.instance.collection("reportProperty").get().then((QuerySnapshot snapshot) => {
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          width: MediaQuery
                                              ...
                                              .size
                                              .width/2,
                                          child: Text(reportPropertyList[index]['projectName'], style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                                        ),
                                      ),
                                      Expanded(
                                          child: Container(
                                      ...
                                      child: RichText(
                                        text: TextSpan(
                                            ...
                                            children: [
                                              TextSpan(
                                                // text: "Builder",
                                                  text: reportPropertyList[index]['postedBy'],
