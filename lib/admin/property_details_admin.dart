...
class _Admin_Property_DetailsState extends State<Admin_Property_Details> {
  ...
  CollectionReference data1 = FirebaseFirestore.instance.collection('propertyDetails');
  CollectionReference data2 = FirebaseFirestore.instance.collection('Users');
  bool rBool;
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("propertyDetails").doc(widget.id).snapshots(),
