...
import 'package:construction_application/admin/property_details_admin.dart';
...
class Project_Landmark_Search extends StatefulWidget {
  final String pn;
  const Project_Landmark_Search({Key key, this.pn}) : super(key: key);

  @override
  _Project_Landmark_SearchState createState() => _Project_Landmark_SearchState();
}
