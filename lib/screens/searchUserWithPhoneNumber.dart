...
class searchByPhoneNumber extends StatefulWidget {
  @override
  _searchByPhoneNumberState createState() => _searchByPhoneNumberState();
}

class _searchByPhoneNumberState extends State<searchByPhoneNumber> {
  String name = "";
  var doc_id;
  var route;
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: (name != "" && name != null)
            ...
            .collection('Users')
            .where('mobileNumber', isEqualTo: name)
            .snapshots()
