...
class searchBySellOrRent extends StatefulWidget {
  @override
  _searchBySellOrRentState createState() => _searchBySellOrRentState();
}

class _searchBySellOrRentState extends State<searchBySellOrRent> {
  String name = "";
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: (name != "" && name != null)
            ...
            .where('sellOrRent', isEqualTo: name)
            .snapshots()
