...
class searchByPostedBY extends StatefulWidget {
  @override
  _searchByPostedByState createState() => _searchByPostedByState();
}

class _searchByPostedByState extends State<searchByPostedBY> {
  String name = "";
  var doc_id;
  var route;
