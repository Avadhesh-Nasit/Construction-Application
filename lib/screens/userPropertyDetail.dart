...
class userPropertyDetail extends StatefulWidget {
  //final String doc;
  //const propertyDetail({Key key, this.doc}) : super(key: key);
  final String value;

  const userPropertyDetail({Key key, this.value}) : super(key: key);

  @override
  _userPropertyDetailState createState() => _userPropertyDetailState(value);
}

class _userPropertyDetailState extends State<userPropertyDetail> {
  final String value;
  _userPropertyDetailState(this.value);
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream:FirebaseFirestore.instance.collection("Users").doc(FirebaseAuth.instance.currentUser.uid).collection('usersPost').doc(value).snapshots(),
