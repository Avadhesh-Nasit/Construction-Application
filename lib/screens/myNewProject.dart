...
import 'package:construction_application/screens/postProjectDetail.dart';
...
class MyNewProject extends StatefulWidget {
  @override
  _MyNewProjectState createState() => _MyNewProjectState();
}

class _MyNewProjectState extends State<MyNewProject> {
  ...
  fetchDatabaseList() async {
    dynamic resultant = await UserNewPostManager().getUsersPostList();
                        ...
                        FirebaseFirestore.instance
                            ...
                            route = MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  postProjectDetail(value: doc_id),
